...
class Mutation(Enum):
    ...
    OFFHAND_PUNCH_MUTATION = 101
    OFFHAND_PUNCH_W_CLAWS_MUTATION = 102
    OFFHAND_PUNCH_W__BLADE_HANDS_MUTATION = 103
    HEADBUTT_MUTATION = 104
    PECK_MUTATION = 105
    KICK_W_HOOVES_MUTATION = 106
    KICK_W_TALONS_MUTATION = 107
    TAIL_SLAP_MUTATION = 108
    TAIL_SLAP_W_STINGER_MUTATION = 109
    BITE_W_FANGS_MUTATION = 1010
    BITE_W_ACIDIC_BITE_MUTATION = 1011
    BITE_W_ANTI_MAGIC_BITE_MUTATION = 1012
    PSEUDOPODS_MUTATION = 1013
    TENTACLE_SPIKE_MUTATION = 1014
    TENTACLE_SLAP_MUTATION = 1015
    TENTACLES_SQUEEZE_MUTATION = 1016
    CONSTRICTION_MUTATION = 1017
...
class MutationMapping:
    ...
    mutation_menu_messages_lookup = {
        ...
        "": Mutation.OFFHAND_PUNCH_MUTATION,
        "": Mutation.OFFHAND_PUNCH_W_CLAWS_MUTATION,
        "": Mutation.OFFHAND_PUNCH_W__BLADE_HANDS_MUTATION,
        "You reflexively headbutt those who attack you in melee": Mutation.HEADBUTT_MUTATION,
        "": Mutation.PECK_MUTATION,
        "": Mutation.KICK_W_HOOVES_MUTATION,
        "": Mutation.KICK_W_TALONS_MUTATION,
        "": Mutation.TAIL_SLAP_MUTATION,
        "": Mutation.TAIL_SLAP_W_STINGER_MUTATION,
        "": Mutation.BITE_W_FANGS_MUTATION,
        "": Mutation.BITE_W_ACIDIC_BITE_MUTATION,
        "": Mutation.BITE_W_ANTI_MAGIC_BITE_MUTATION,
        "": Mutation.PSEUDOPODS_MUTATION,
        "": Mutation.TENTACLE_SPIKE_MUTATION,
        "": Mutation.TENTACLE_SLAP_MUTATION,
        "": Mutation.TENTACLES_SQUEEZE_MUTATION,
        "": Mutation.CONSTRICTION_MUTATION,
    }
