...
from dcss.connection.local import auth, checkoutput, config, userdb, util, load_games
...
def find_running_game(charname, start):
    from dcss.connection.local.process_handler import processes
...
class CrawlWebSocket(tornado.websocket.WebSocketHandler):
    ...
    def start_crawl(self, game_id):
        ...
        from dcss.connection.local import process_handler
