...
import dcss.connection.local
from dcss.connection.local import auth, load_games, process_handler, userdb, config
from dcss.connection.local import game_data_handler, util, ws_handler
