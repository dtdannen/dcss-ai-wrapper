...
class Command(Enum):
    ...
    #  Rest
    REST_AND_LONG_WAIT = 8
    WAIT_1_TURN = 9

    #  Extended Movement
    AUTO_EXPLORE = 10
    INTERLEVEL_TRAVEL = 11
    FIND_ITEMS = 12
    SET_WAYPOINT = 13
    LONG_WALK_SW = 14
    LONG_WALK_S = 15
    ...
    ATTACK_WITHOUT_MOVE_SW = 22
    ATTACK_WITHOUT_MOVE_S = 23
    ATTACK_WITHOUT_MOVE_SE = 24
    ATTACK_WITHOUT_MOVE_W = 25
    ATTACK_WITHOUT_MOVE_E = 26
    ATTACK_WITHOUT_MOVE_NW = 27
    ATTACK_WITHOUT_MOVE_N = 28
    ATTACK_WITHOUT_MOVE_NE = 29

    #  Autofight
    AUTO_FIGHT = 30
    AUTO_FIGHT_WITHOUT_MOVE = 31

    #  Item types (and common commands)
    WIELD_HAND_WEAPON = 32
    QUIVER_MISSILE = 33
    FIRE_MISSILE = 34
    SELECT_MISSILE_AND_FIRE = 35
    CYCLE_MISSILE_FORWARD = 36
    CYCLE_MISSILE_BACKWARD = 37
    WEAR_ARMOUR = 38
    TAKE_OFF_ARMOUR = 39
    CHOP_CORPSE = 40
    EAT = 41
    ...
    REMOVE_JEWELLERY = 45
    EVOKE = 46
    SELECT_ITEM_TO_EVOKE = 47
    MEMORISE = 48
    COUNT_GOLD = 49

    #  Other gameplay actions
    USE_SPECIAL_ABILITY = 50
    CAST_SPELL_ABORT_WITHOUT_TARGETS = 51
    CAST_SPELL_NO_MATTER_WHAT = 52
    LIST_ALL_SPELLS = 53
    TELL_ALLIES = 54
    REDO_PREVIOUS_COMMAND = 55
